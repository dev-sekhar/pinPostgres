...
router.post("/", requirePermission("manufacturer.create") as any, validateSchema("Manufacturer") as any, async (req: AuthRequest, res) => {
...
router.put("/:id", requirePermission("manufacturer.update") as any, validateSchema("Manufacturer") as any, async (req: AuthRequest, res) => {
