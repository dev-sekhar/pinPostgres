...
// POST /api/products
router.post("/", requirePermission("product.create") as any, validateSchema("Product") as any, async (req: AuthRequest, res) => {
...
// PUT /api/products/:id
router.put("/:id", requirePermission("product.update") as any, validateSchema("Product") as any, async (req: AuthRequest, res) => {
